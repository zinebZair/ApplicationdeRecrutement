...
<head>
	...
	<title>OuZi- Change Password</title>
				...
				<div class="container">
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="../job-list.php">Lisre d'emploi</a>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li><a href="../">OuZi</a></li>
						<li><span>Changer Mot de passe</span></li>
					</ol>
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<ul class="admin-user-menu clearfix">
										...
										<li>
											<a href="../company.php?ref=<?php echo "$myid"; ?>"><i class="fa fa-briefcase"></i> Présentation de l'entreprise</a>
										</li>
										<li>
											<a href="my-jobs.php"><i class="fa fa-bookmark"></i>Emplois publiés</a>
										</li>
										<li>
											...
											<div class="row gap-20">
                                             <?php include 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-12 mt-10">
													<button type="submit" onclick="return check_passwords();" class="btn btn-primary">Mise a jour</button>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Mail : <a href="mailto:nightingale.nath2@gmail.com"> easyjob.ouzi@gmail.com</a></p>
								<p>Téléphone : <a href="tel:+233546607474"> 05 22 32 44 45</a></p>
