			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span>Publier une offre</span></li>
					</ol>
							...
							<div class="col-sm-5 col-md-4">
								...
								<div class="company-detail-sidebar">
									...
									<ul class="meta-list clearfix">
										...
										<li>
											<h4 class="heading">Site Internet: </h4>
								...
								<div class="company-detail-wrapper">
									...
									<div class="company-detail-company-overview  mt-0 clearfix">
										...
										<div class="section-title-02">
											<h3 class="text-left">Publier un poste</h3>
										</div>
											...
											<?php require 'constants/check_reply.php'; ?>
												...
												<div class="col-xss-12 col-xs-6 col-sm-6 col-md-4">
													...
													<div class="form-group mb-20">
														...
														<select name="experience" required class="selectpicker show-tick form-control" data-live-search="false" data-selected-text-format="count > 3" data-done-button="true" data-done-button-text="OK" data-none-selected-text="All">
															...
															<option value="2 Years">2 ans(DEUST)</option>
															<option value="3 Years">3 ans(LST)</option>
															<option value="4 Years">4 ans</option>
															<option value="5 Years">5 ans(MST)</option>
														</select>
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														<label>Description d'emploi</label>
												...
												<div class="col-sm-6 mt-30">
													<button type="submit"  onclick = "validate(this)" class="btn btn-primary btn-lg">Publiez votre offre d'emploi</button>
												</div>
				...
				<div class="main-footer">
					...
					<div class="container">
						...
						<div class="row">
							...
							<h5 class="footer-title">OuZi Contact</h5>
