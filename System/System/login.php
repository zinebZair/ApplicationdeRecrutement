					...
					<div class="row">
						...
						<div class="col-md-10 col-md-offset-1">
							...
							<div class="row">
                                ...
                                <div class="modal-header">
                                <h4 class="modal-title text-center" style="color:orange;">Accéder à votre compte </h4>
                                </div>
								...
								<a data-toggle="modal" onclick = "reset_text()" href="#forgotPasswordModal" style="color:#008dad;;">Mot de passe oublié ?</a> 
							    </div>
						      </div>	
...
<div class="modal-footer text-center">
<button type="submit" class="btn btn-primary"style="border-radius: 300px; color:white; background-color:orange;">Connexion</button>
</div>
				...
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					<h4 class="modal-title text-center">Restaurer votre mot de passe oublié</h4>
				</div>
				...
				<div class="modal-body">
					<div class="row gap-20">
						...
						<div class="col-sm-12 col-md-12">
							<p class="mb-20">Entrez l'adresse mail associée à votre compte, nous vous enverrons le lien pour réinitialiser votre mot de passe</p>
						</div>
						...
						<div class="col-sm-12 col-md-12">
							...
							<div class="form-group"> 
								...
								<label>Addresse Mail</label>
								<input id="mymail" autocomplete="off" name="email" class="form-control" placeholder="" type="email" required> 
							</div>
						...
						<div class="col-sm-12 col-md-12">
							<div class="login-box-box-action">
								Retourner a <a data-dismiss="modal">Connexion</a>
								<p id="data"></p>
							</div>
				...
				<div class="modal-footer text-center">
					<button  onclick="update(mymail.value)" type="submit" class="btn btn-primary">Restaurer</button>
