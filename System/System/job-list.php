...
<head>
	...
	<title>OuZi - Liste d'emploi<?php echo "$title"; ?></title>
				...
				<div class="container">
					...
					<form action="job-list.php" method="GET" autocomplete="off">
						...
						<div class="second-search-result-inner">
							<span class="labeling">Chercher un emploi</span>
							<div class="row">
							<br> <br>
								...
								<div class="col-xss-12 col-xs-6 col-sm-4 col-md-2">
									<button name="search" value="✓" type="submit" class="btn btn-block">chercher</button>
								</div>
