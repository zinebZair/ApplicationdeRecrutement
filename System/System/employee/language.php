				...
				<div class="container">
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="../employers.php">Reruteur</a>
							</li>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<ul class="admin-user-menu clearfix">
										...
										<li>
											<a href="academic.php"><i class="fa fa-graduation-cap"></i> Qualifications academiques</a>
										</li>
										<li>
											<a href="experience.php"><i class="fa fa-briefcase"></i>Experience</a>
										</li>
										<li>
											<a href="attachments.php"><i class="fa fa-folder-open"></i> Autres pièce jointe</a>
										</li>
										<li>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
											...
											<div class="row">
												...
												<div class="col-sm-12 col-md-2">
													...
													<div class="resume-list-btn">
							                            ...
							                            <div class="form-group"> 
								                        <label>Vous lisez</label>
								                        <select name="read" required class="selectpicker show-tick form-control" data-live-search="false">
									                    <option <?php if ($row ['reading'] == "Fair") { print ' selected '; } ?> value="Fair">Moyen</option>
							                            ...
							                            <div class="form-group"> 
								                        <label>Vous ecrivez</label>
								                        <select name="write" required class="selectpicker show-tick form-control" data-live-search="false">
									                    <option <?php if ($row ['writing'] == "Fair") { print ' selected '; } ?> value="Fair">Moyen</option>
								...
								?>
				                    ...
				                    <div class="modal-header">
					                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					                 <h4 class="modal-title text-center">Nouveau langues</h4>
				                    </div>
									...
									<option value="Fair">Moyen</option>
									<option value="Good">Bien</option>
									<option value="Very Good">Tres bien</optio>
									</select>
							        </div>
