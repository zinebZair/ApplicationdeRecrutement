						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<ul class="admin-user-menu clearfix">
										...
										<li>
											<a href="language.php"><i class="fa fa-language"></i> Maîtrise de la langue</a>
										</li>
										<li class="active">
											<a href="training.php"><i class="fa fa-gears"></i> Formation</a>
										</li>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
							        ...
							        <div class="form-group"> 
								    <label>Joindre votre attestation <b>*(Leave blank if you dont want to update)*</b></label>
								...
								?>
				                    ...
				                    <div class="modal-header">
					                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					                 <h4 class="modal-title text-center">Formation</h4>
				                    </div>
