						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<ul class="admin-user-menu clearfix">
										...
										<li>
											<a href="language.php"><i class="fa fa-language"></i> Langue</a>
										</li>
										<li>
											<a href="training.php"><i class="fa fa-gears"></i> stage</a>
										</li>
										<li class="active">
											<a href="referees.php"><i class="fa fa-users"></i> Les références</a>
										</li>
										<li >
										...
										<li>
											<a href="attachments.php"><i class="fa fa-folder-open"></i> Autres pièces jointes</a>
										</li>
										<li>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
							        ...
							        <div class="form-group"> 
								    <label>Téléphone de référence</label>
								...
								?>
				                    ...
				                    <div class="modal-header">
					                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					                 <h4 class="modal-title text-center">Ajouter references</h4>
				                    </div>
							        ...
							        <div class="form-group"> 
								    <label>Nom de l'établissement (vous)</label>
