...
<head>
	...
	<title>OuZi- Qualifications professionnelles</title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li><a href="../">OuZi</a></li>
						<li><span>Qualifications professionnelles</span></li>
					</ol>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<div class="admin-user-action text-center">
										...
										<a target="_blank" href="my_cv" class="btn btn-primary btn-sm btn-inverse">Voir mb_convert_variables CV</a>
									...
									<ul class="admin-user-menu clearfix">
										...
										<li>
											<a href="applied-jobs.php"><i class="fa fa-bookmark"></i> Emplois appliaues</a>
										</li>
										<li>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
							        ...
							        <div class="form-group"> 
								    <label>Joindre votre attestation <b>*(Laissez vide si vous ne voulez pas mettre à jour)*</b></label>
				                   ...
				                   <div class="modal-footer text-center">
				 	               <button type="submit" class="btn btn-primary">Soumattre</button>
								...
								?>
				                    ...
				                    <div class="modal-header">
					                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					                 <h4 class="modal-title text-center"> Ajouter Qualifications Academiques</h4>
				                    </div>
