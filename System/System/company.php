...
<head>
	...
	<title>OuZi - Entreprise <?php echo "$compname"; ?></title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li><a href="employers.php">Receuteur</a></li>
							...
							<div class="col-md-10 col-md-offset-1">
								...
								<div class="company-detail-wrapper">
									...
									<div class="section-title mb-40">
										...
										<h4 class="text-left">Emplois offerts à <?php echo "$compname"; ?></h4>
										 ...
										 ?>
											...
											<div class="content">
												...
												<div class="job-item-list-bottom">
													...
													<div class="col-sm-5 col-md-4">
														<a target="_blank" href="explore-job.php?jobid=<?php echo $row['job_id']; ?>" class="btn btn-primary">Voir ce emploi</a>
													</div>
