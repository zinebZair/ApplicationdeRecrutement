...
<head>
	...
	<title>OuZi - Réinitialiser le mot de passe</title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list">
						...
						<li><span>Rréinitialiser le mot de passe</span></li>
					</ol>
					...
					<div class="row">
						...
						<div class="col-md-10 col-md-offset-1">
							...
							<div class="row">
                                ...
                                <div class="modal-header">
                                <h4 class="modal-title text-center">Rréinitialiser votre mot de passe</h4>
                                </div>
